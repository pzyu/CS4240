...
namespace Lean.Pool
{
	/// <summary>This component shows you how you can easily spawn and despawn a prefab using the delay functionality - same as Destroy(obj, __delay__).</summary>
	[HelpURL(LeanPool.HelpUrlPrefix + "LeanDelayedPooling")]
