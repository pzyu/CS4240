...
namespace Lean.Pool
{
	/// <summary>This script shows you how to benchmark the speed of spawning and despawning prefabs vs instantiate and destroy.</summary>
	[HelpURL(LeanPool.HelpUrlPrefix + "LeanPoolBenchmark")]
